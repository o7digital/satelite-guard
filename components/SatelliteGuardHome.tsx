  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#02050b] text-white">
      <section className="relative isolate min-h-screen border-b border-white/10 bg-[#02050b]">
        <div className="absolute inset-0 bg-[url('https://unsplash.com/photos/6wohP_DrSWw/download?force=true&w=2200')] bg-cover bg-[70%_center] opacity-45" />
              ...
              <div className="relative ml-auto w-full max-w-[42rem]">
                <div className="rounded-[2.5rem] border border-white/10 bg-[#07101c]/40 p-4 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
                  <div className="relative h-[38rem] overflow-hidden rounded-[2rem]">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_25%,rgba(34,211,238,0.16),transparent_14%),radial-gradient(circle_at_75%_22%,rgba(251,191,36,0.14),transparent_16%),linear-gradient(180deg,rgba(3,7,18,0.12),rgba(3,7,18,0.46))]" />
                    <div className="absolute inset-0 bg-[url('https://unsplash.com/photos/6wohP_DrSWw/download?force=true&w=1800')] bg-cover bg-[center_right] opacity-45" />
                    <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(2,6,23,0.78),rgba(2,6,23,0.28),rgba(2,6,23,0.62))]" />
